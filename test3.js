          ...
          /********************************************* */
              ...
              .then(result => {
                ...
                try {
                  ...
                  let sql = "INSERT IGNORE INTO articlesdetails (id_category, id_page, title, summary, url_image, content, caption) VALUES ('1', '3', '"+result.title+"', '"+result.summary+"', '"+result.urlImage+"', '"+result.content+"', '"+result.caption+"')";
                  conn
